import{_ as s,c as i,o as a,a8 as n}from"./chunks/framework.UwPfSqyn.js";const E=JSON.parse('{"title":"게시판 스킨","description":"그누보드의 게시판 스킨을 만들기 위해 알아야 할 게시판 스킨의 구조와 스킨에서 사용할 수 있는 변수를 확인하고 사용해야 한다.","frontmatter":{"head":[["link",{"name":"canonical","content":"https://g5guide.github.io/make/skin/board.html"}]],"description":"그누보드의 게시판 스킨을 만들기 위해 알아야 할 게시판 스킨의 구조와 스킨에서 사용할 수 있는 변수를 확인하고 사용해야 한다."},"headers":[],"relativePath":"make/skin/board.md","filePath":"make/skin/board.md","lastUpdated":1737513849000}'),p={name:"make/skin/board.md"},l=n(`<h1 id="게시판-스킨" tabindex="-1">게시판 스킨 <a class="header-anchor" href="#게시판-스킨" aria-label="Permalink to &quot;게시판 스킨&quot;">​</a></h1><p>게시판 스킨은 게시판의 목록, 글 내용 보기, 댓글 및 댓글 쓰기, 글 쓰기 폼의 스킨으로 구성되어 있다.</p><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">skin</span></span>
